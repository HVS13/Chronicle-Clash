...
```html
<a class="cc-keyword-link" data-keyword="keyword-evade" href="#">Evade</a>
<a class="cc-status-link" data-status="status-slow" href="#">Slow</a>
<a class="cc-term-link" data-term="term-created-card" href="#">Created Card</a>
<a class="cc-role-link" data-role="role-striker" href="#">Striker</a>
```
