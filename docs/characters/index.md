...
Pick a character to view their cards. Use the filter to narrow by name, version, or tags.

<div class="cc-filter">
  <label class="cc-filter__label" for="character-filter">Filter characters</label>
  <input class="cc-filter__input" type="search" id="character-filter" placeholder="Type a name, version, or tag..." autocomplete="off" spellcheck="false" />
</div>
