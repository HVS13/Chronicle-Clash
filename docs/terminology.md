...
<div class="cc-filter">
  <label class="cc-filter__label" for="term-filter">Filter terms</label>
  <input class="cc-filter__input" type="search" id="term-filter" placeholder="Type to filter..." autocomplete="off" spellcheck="false" />
</div>
