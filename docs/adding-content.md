...
```html
<div class="cc-entry keyword-entry" id="keyword-<slug>">
  <p class="cc-entry__title">Keyword Name</p>
  <p class="cc-entry__desc">Definition.</p>
</div>
```
...
```html
<a class="cc-keyword-link" data-keyword="keyword-<slug>" href="#">Keyword Name</a>
```
...
```html
<div class="cc-entry status-entry" id="status-<slug>">
  <p class="cc-entry__title">Status name</p>
  <p class="cc-entry__desc">Description.</p>
</div>
```
...
```html
<a class="cc-status-link" data-status="status-<slug>" href="#">Status name</a>
```
...
```html
<div class="cc-entry role-entry" id="role-<slug>">
  <p class="cc-entry__title">Role name</p>
  <p class="cc-entry__desc">Role description text.</p>
</div>
```
...
```html
<a class="cc-role-link" data-role="role-<slug>" href="#">Role name</a>
```
...
```html
<a class="cc-card-type-link" data-card-type="card-type-<slug>" href="#">Card type name</a>
```
...
```html
<a class="cc-term-link" data-term="term-<slug>" href="#">Term</a>
```
...
```html
<div class="cc-filter">
  <label class="cc-filter__label" for="my-filter">Filter</label>
  <input class="cc-filter__input" type="search" id="my-filter" placeholder="Type to filter..." autocomplete="off" spellcheck="false" />
</div>
```
