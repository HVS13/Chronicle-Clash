...
This page collects frequently asked questions about Chronicle Clash.
...
??? question "How do On Gain and delayed status triggers work?"
    <a class="cc-term-link" data-term="term-on-gain" href="#">On Gain</a> resolves immediately when the status is gained, even if it is not Turn Start. If an effect says "When this expires: At your next Turn Start, ...", it queues a delayed trigger that still resolves at that next Turn Start even after the status is gone.
    Example: If you gain Gear 3rd during your turn, you immediately gain 3 <a class="cc-status-link" data-status="status-strength" href="#">Strength</a> and 1 <a class="cc-status-link" data-status="status-slow" href="#">Slow</a>. Gear 3rd expires at Turn End, but its expiration still schedules Deflate at your next Turn Start.
