(() => {
  ...
  const init = () => {
    ...
    setupReferenceLinks({
      selector: 'a.cc-keyword-link[data-keyword]',
    ...
    setupReferenceLinks({
      selector: 'a.cc-status-link[data-status]',
    ...
    setupReferenceLinks({
      selector: 'a.cc-card-type-link[data-card-type]',
    ...
    setupReferenceLinks({
      selector: 'a.cc-term-link[data-term]',
    ...
    setupReferenceLinks({
      selector: 'a.cc-role-link[data-role]',
